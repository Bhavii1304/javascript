...
// createImage("/Section16/img-1.jpg")
//   .then((img) => {
//     currentImg = img;
...
//     return createImage("/Section16/img-2.jpg");
//   })
//   .then((img) => {
//     currentImg = img;
...
// --------- other promise combinators race all settled and any---------------
// promise.race in this the 1st settled promise wins the race
// (async function () {
...
const loadNPause = async function () {
  try {
    // Load image 1
    let img = await createImage("Section16/img-1.jpg");
    console.log("Image 1 loaded");
    await wait(2);
    img.style.display = "none";

    // Load image 1
    img = await createImage("Section16/img-2.jpg");
    console.log("Image 2 loaded");
    await wait(2);
    img.style.display = "none";
  } catch (err) {
...
loadAll(["Section16/img-1.jpg", "Section16/img-2.jpg", "Section16/img-3.jpg"]);
